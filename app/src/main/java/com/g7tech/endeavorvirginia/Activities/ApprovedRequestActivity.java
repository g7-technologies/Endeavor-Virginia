...
public class ApprovedRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.setTitle(getString(R.string.request_opt2));
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.action_dashboad:
                    Intent intent = new Intent(ApprovedRequestActivity.this,HomeActivity.class);
                    startActivity(intent);
                    return true;
                case R.id.action_messages:
                    Intent intent1 = new Intent(ApprovedRequestActivity.this,HomeActivity.class);
                    startActivity(intent1);
                    return true;
                case R.id.action_profile:
                    Intent intent2 = new Intent(ApprovedRequestActivity.this,HomeActivity.class);
    ...
    private void loadPendingRequests() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConfig.URL_APPROVED_REQUESTS+"?id="+sessionManager.getUserId(),
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            PendingRequestsAdapter adapter = new PendingRequestsAdapter(ApprovedRequestActivity.this, PendingRequestsList);
