...
public class CompletedRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.setTitle(getString(R.string.request_opt4));
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.action_dashboad:
                    Intent intent = new Intent(CompletedRequestActivity.this,HomeActivity.class);
                    startActivity(intent);
                    return true;
                case R.id.action_messages:
                    Intent intent1 = new Intent(CompletedRequestActivity.this,HomeActivity.class);
                    startActivity(intent1);
                    return true;
                case R.id.action_profile:
                    Intent intent2 = new Intent(CompletedRequestActivity.this,HomeActivity.class);
    ...
    private void loadPendingRequests() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AppConfig.URL_COMPLETED_REQUESTS+"?id="+sessionManager.getUserId(),
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            PendingRequestsAdapter adapter = new PendingRequestsAdapter(CompletedRequestActivity.this, PendingRequestsList);
